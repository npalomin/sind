...
5. On the EpiCollect app conduct start the survey by recording the __Functional Unit Code__ of the corresponding polygon. Note: In the previous example, this correspond to one of the 3 new created FUCs. The 'original' FUC=76 will not be included on the survey.
